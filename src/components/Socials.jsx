    ...
    return (
        <div>
            <ul className='ml-1 mt-8 flex items-center gap-4' aria-label='Social media'>
                <li>
                    <a href="https://www.linkedin.com/in/rhenzala/" target='_blank' rel='noreferrer noopener' 
                    title='Linkedin'
                    className='group'>
                ...
                <li>
                    <a href="https://github.com/rhenzala" 
                    target='_blank' 
                ...
                <li>
                    <a href="mailto:rhenzala@gmail.com"
                    className='group'>
                        <Mail className="text-slate-500 group-hover:text-slate-200 transition-colors duration-300" 
                        size={24} />
                    </a>
                </li>
            </ul>
